...
namespace Kata.Spec
{
    ...
    public class when_user_input_contains_multiple_negatives
    {
        ...
        {
            _result.Message.Should().Be("negatives not allowed: -1, -2, -3");
        };
    ...
    public class when_Input_contains_number_larger_than_1000
    {
        Establish _context = () => { _systemUnderTest = new Calculator(); };

        Because of = () => { _result = _systemUnderTest.Add("1000,1001,2"); };

        It should_ignore_that_numbers = () => { _result.Should().Be(1002); };
        private static Calculator _systemUnderTest;
        private static int _result;
    }

    public class when_using_one_multi_character_delimiter
    {
        Establish _context = () => { _systemUnderTest = new Calculator(); };
    ...
    public class when_having_multiple_custom_delimiters
    {
        Establish _context = () => { _systemUnderTest = new Calculator(); };
