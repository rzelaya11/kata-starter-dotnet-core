...
public class when_Sending_empty_input
{
    Establish _context = () =>
    {
...
public class when_adding_with_one_number
{
    Establish _context = () =>
    {
    ...
    Because of = () => { _result = _systemUnderTest.Sum("2"); };
...
public class when_Input_is_more_than_one_number
{
    Establish _context = () =>
    {
        _systemUnderTest = new Calculator();
